"""Rare Candy Pokemon monitor.

Rare Candy is a marketplace for Pokemon TCG sealed product.
https://rarecandy.com
"""
...
class RareCandyMonitor(RetailerMonitor):
    name = "rarecandy"
    ...
    async def check_scrape(self, product_url: str, product_name: str) -> ProductResult:
        ...
        if json_ld:
            try:
                ...
                logger.debug("Failed to parse Rare Candy JSON-LD: %s", exc)
